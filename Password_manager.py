...
class PasswordManager(Tk):
    ...
    def create_widgets(self):
        ...
        Label(
            content_frame,
            text="Manage your passwords here",
        ...
        Label(manage_frame, text="Site", bg="black", fg="white").grid(
            row=0, column=0, padx=5
        )
        Label(manage_frame, text="Username", bg="black", fg="white").grid(
            row=0, column=1, padx=5
        )
        Label(manage_frame, text="Password", bg="black", fg="white").grid(
        ...
        Button(
            manage_frame, text="Add", command=self.add_password, bg="gray", fg="white"
    ...
    def add_password(self):
        ...
        if site and username and password:
            ...
            self.passwords.append(
                {"site": site, "username": username, "password": encrypted_password}
            )
            self.save_passwords()
        ...
        for idx, entry in enumerate(self.passwords):
            try:
                ...
                Label(
                    ...
                    text=f"{idx+1}. {entry['site']} - {entry['username']} - {decrypted_password}",
                    bg="black",
                    fg="white",
                ).pack(anchor="w")
